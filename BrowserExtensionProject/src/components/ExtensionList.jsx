    ...
    return(
        <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex gap-3">
                ...
                <button onClick={handleInactive} className={`${showOnlyInactive ? "bg-red-400 text-Neutral900 font-semibold hover:bg-red-400" : "bg-none"} ${isDarkMode ? "bg-Neutral-800 hover:bg-gray-600" : "bg-Neutral-100 hover:bg:Neutral-300 text-Neutral900"} cursor-pointer  rounded-3xl px-4 py-2 `}>Inactive</button>
            </div>
        </div>
    )
}