...
const Modal = ({showModal}) => {
  return (
    <div className={`${showModal ? "" : "hidden"} bg-white rounded-lg absolute max-w-[700px] max-h-[800px] inset-x-0 mx-auto h-96 fixed top-20 z-10 p-8 overflow-auto no-scrollbar`}>
      <h2 className='font-bold text-xl mb-6'>Back this project</h2>
      <p className='mb-8'>Want to support us in bringing Mastercraft Bamboo Monitor Riser out in the world?</p>
